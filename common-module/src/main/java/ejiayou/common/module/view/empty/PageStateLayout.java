...
import ejiayou.common.module.view.empty.utils.PageState;
import ejiayou.common.module.view.empty.widget.MaterialProgress;
import ejiayou.common.module.view.empty.widget.RippleView;
...
public class PageStateLayout extends FrameLayout implements PageStateListener {
    ...
    private View initLoadingView() {
        View loadingView = LayoutInflater.from(mContext).inflate(R.layout.ensd_empty_loading, null, false);
...
//        );
    ...
    private View getErrorView() {
        if (0 == Builder.error) {
            ...
            mErrorView.setVisibility(View.GONE);//新加入的隐藏
        } else {
    ...
    private View initErrorView() {
        View errorView = LayoutInflater.from(mContext).inflate(R.layout.ensd_empty_error, null, false);
        LayoutParams params = new LayoutParams(
    ...
    private View getEmptyView() {
        if (0 == Builder.empty) {
            ...
            mEmptyView.setVisibility(View.GONE);//新加入的隐藏
        } else {
    ...
    private View initEmptyView() {
        View emptyView = LayoutInflater.from(mContext).inflate(R.layout.ensd_empty_empty, null, false);
        LayoutParams params = new LayoutParams(
                LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT
        );
